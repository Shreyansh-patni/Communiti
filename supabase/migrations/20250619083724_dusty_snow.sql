/*
  ...
  1. Core Entities
    - Users: Extended profiles with business metrics
...
-- Insert Categories
INSERT INTO categories (name, description, color_gradient, icon, sort_order) VALUES
('Tech Innovation', 'Cutting-edge technology, startups, and digital transformation', 'from-blue-500 to-cyan-500', '💻', 1),
('Creative Design', 'UI/UX design, visual arts, and creative expression', 'from-purple-500 to-pink-500', '🎨', 2),
('Business Growth', 'Entrepreneurship, marketing, and business strategy', 'from-green-500 to-emerald-500', '📈', 3),
('Health & Wellness', 'Mental health, fitness, and work-life balance', 'from-emerald-500 to-teal-500', '🌱', 4),
('Learning & Development', 'Skill development, courses, and knowledge sharing', 'from-orange-500 to-red-500', '📚', 5);

-- Insert Products (Subscription Tiers)
INSERT INTO products (name, description, type, price, currency, billing_interval, features, limitations, is_active) VALUES
('Communiti Pro', 'Enhanced features for power users and professionals', 'subscription', 19.99, 'USD', 'monthly',
...
('Communiti Enterprise', 'Full-featured solution for organizations and teams', 'subscription', 199.99, 'USD', 'monthly',
